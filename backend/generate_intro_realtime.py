...
INTRO_TEXT = (
    "היי, נעים מאוד, אני שחף ישראל, בן 28 מקריית אתא, בוגר הנדסת תוכנה ממכללת אורט בראודה. "
    "במהלך הלימודים עשיתי התמחות בחברת Hexagon, שם הצטרפתי לצוות פיתוח אגילי "
