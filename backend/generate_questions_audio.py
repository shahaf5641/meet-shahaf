...
QUESTIONS = [
    {
        "file": "q1_hexagon.wav",
        "text": (
            "ב-Hexagon עשיתי internship כחלק מצוות פיתוח, בתפקיד SDET. "
            ...
            "הניסיון הזה לימד אותי לכתוב קוד ברמה תעשייתית ולעבוד נכון בתוך צוות."
        ),
    },
    {
    ...
    },
    {
        "file": "q6_future.wav",
        "text": (
            "אני לא מגדיר לעצמי תואר ספציפי — "
