      ...
      <footer className="contact-footer">
        <div className="footer-inner">
          ...
          <div className="footer-group">
            <span className="footer-group-label">יצירת קשר</span>
            <button className="footer-item footer-copy" onClick={() => copyToClipboard('shahaf564@gmail.com', 'email')}>
              ...
              <span>{copiedItem === 'email' ? '✓ הועתק' : 'shahaf564@gmail.com'}</span>
            </button>
            <button className="footer-item footer-copy" onClick={() => copyToClipboard('0545699472', 'phone')}>
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" width="16" height="16"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 13a19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 3.6 2h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.91 9.91a16 16 0 0 0 6.18 6.18l1.27-1.27a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"/></svg>
              <span>{copiedItem === 'phone' ? '✓ הועתק' : '054-5699-472'}</span>
            </button>
          </div>
          ...
          <div className="footer-group">
            <span className="footer-group-label">קישורים</span>
            ...
            <a href="https://shahafs-website.vercel.app/" target="_blank" rel="noreferrer" className="footer-item">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" width="16" height="16"><circle cx="12" cy="12" r="10"/><path d="M2 12h20M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg>
              פורטפוליו
            </a>
          </div>
          ...
          <a href="/shahaf_cv.pdf" download="Shahaf_Israel_CV.pdf" className="footer-cv-btn">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" width="17" height="17"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>
            הורד קורות חיים
          </a>
