  ...
  async function startCall() {
    ...
    try {
      ...
      await new Promise((resolve) => {
        ...
        setCallState('active')
        setTranscript('היי, נעים מאוד, אני שחף ישראל, בן 28 מקריית אתא, בוגר B.Sc. בהנדסת תוכנה ממכללת אורט בראודה. במהלך השנה האחרונה ללימודים שלי עבדתי כסטודנט בחברת Hexagon, עבדתי בצוות פיתוח שם השתלבתי בסביבת פיתוח אגילית ועבדתי בעיקר על תשתיות בדיקות ואוטומציה. במסגרת התפקיד יצרתי בדיקות health-check למערכת מבוססת אירועים, שיפרתי תשתית ליצירת אובייקטים בטסטים, וגם בניתי תשתית לבדיקות הרשאות מקצה לקצה. מעבר לזה, עבדתי על פרויקטים משמעותיים, ביניהם EscapeCode, משחק פאזלים תלת-ממדי ללימוד קוד עם דגש על נגישות, ופרויקט אוטומציה לאיסוף מידע מקבוצות פייסבוק. היום אני מחפש את מקום העבודה הבא שלי, מקום שבו אוכל לצמוח ולהביא ערך אמיתי דרך תוכנה.')
