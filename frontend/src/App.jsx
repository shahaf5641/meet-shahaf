...
const STATIC_ANSWERS = {
  ...
  'ספר לי על EscapeCode — פרויקט הגמר שלך': {
    ...
    transcript: 'EscapeCode הוא משחק פאזל תלת-ממדי שפיתחתי ב-Unity עם C# כפרויקט גמר. כל חידה במשחק מייצגת קונספט תכנותי כמו לולאות ותנאים, בצורה חווייתית. שמתי דגש גדול על נגישות — תמיכה בקוראי מסך, ניגודיות גבוהה ואפשרויות התאמה אישית לממשק.',
  },
