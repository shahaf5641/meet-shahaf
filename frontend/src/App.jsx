  ...
  async function startCall() {
    ...
    try {
      ...
      await new Promise((resolve) => {
        ...
        setCallState('active')
        setTranscript('היי, נעים מאוד, אני שחף ישראל, בן 28 מקריית אתא, בוגר הנדסת תוכנה ממכללת אורט בראודה. במהלך הלימודים עשיתי התמחות בחברת Hexagon, שם הצטרפתי לצוות פיתוח אגילי ועבדתי בעיקר על תשתיות בדיקות ואוטומציה. בין הדברים שעשיתי שם: יצרתי בדיקות health-check למערכת מבוססת אירועים, שיפרתי את תשתית יצירת האובייקטים בטסטים, ובניתי מאפס תשתית לבדיקות הרשאות מקצה לקצה לפי תפקידי המערכת. מעבר לזה, פיתחתי כמה פרויקטים עצמאיים — ביניהם EscapeCode, משחק פאזלים תלת-ממדי ללימוד קוד עם דגש על נגישות, ופרויקט אוטומציה לאיסוף נתונים מקבוצות פייסבוק עם ממשק web מלא. היום אני מחפש את התפקיד הבא שלי — מקום שבו אוכל לצמוח, להתפתח, ולהביא ערך אמיתי.')
